...
export class News extends Component {
  ...
  constructor(props) {
    ...
    document.title = `NewsMonkey - ${this.capitalizedFirstLetter(this.props.category)}`;
  ...
  // async componentDidMount(){
  //   let url = `https://newsapi.org/v2/top-headlines?country=${this.props.country}&category=${this.props.category}&apiKey=10cb2b875143401590d3f1def2698518&page=1&pageSize=${this.props.pageSize}`;
  ...
  // handlePreviousClick = async () =>{
  //   let url = `https://newsapi.org/v2/top-headlines?country=${this.props.country}&category=${this.props.category}&apiKey=10cb2b875143401590d3f1def2698518&page=${this.state.page - 1}&pageSize=${this.props.pageSize}`;
  //   this.setState({loading : true});
  //   let data = await fetch(url);
  //   let parsedData = await data.json();
  //   console.log(parsedData);
      ...
      <>
        ...
        > 
         <div className="container">
            <div className="row">
              {!this.state.loading && this.state.articles.map((element, url)=>{
